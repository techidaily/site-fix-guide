...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Abel';
const subSiteKeywords = `android tool, ios tool, iphone tool, bypass, unlock, repair` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '0bb4f0f477b048f585c63cac1ae7eeed'; // 替换为你的API密钥

---
title: How To Fix Part of the Touch Screen Not Working on Vivo Y28 5G | Dr.fone
date: 2024-05-19T03:58:57.975Z
updated: 2024-05-20T03:58:57.975Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Part of the Touch Screen Not Working on Vivo Y28 5G
excerpt: This article describes How To Fix Part of the Touch Screen Not Working on Vivo Y28 5G
keywords: Vivo Y28 5G android help,android troubleshooting,android guide,Vivo Y28 5G android repair,Vivo Y28 5G fix android problems,android issues,android help,Vivo Y28 5G android tips,Vivo Y28 5G android troubleshooting,Vivo Y28 5G android solutions,Vivo Y28 5G android issues,android fix
thumbnail: https://www.lifewire.com/thmb/b7hSKwI9Oajpbwr32n5Vsf7fcds=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/operationcouldnotcomplete-95695abe458d4062a2c2f7e46e656b08.png
---

## How To Fix Part of the Touch Screen Not Working on Vivo Y28 5G

You probably touch the screen of your phone hundreds of times per day. It’s no surprise that smartphone touchscreens are one of the most common components to fail, given their delicate glass construction. However, a ****part of the touch screen not working**** on your Vivo Y28 5G does not necessarily mean it is a hardware issue. There could be other reasons why your Android’s touch screen stopped responding.
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the Vivo Y28 5G device may be experiencing technical difficulties.
...
- Vivo Y28 5G P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- Vivo Y28 5G ****left side of the screen is not working****
...
- Remove the Vivo Y28 5G device cover and screen protector if they are not damaged.
- If there is a sticker on the Vivo Y28 5G device screen, you must remove it.
...
If you have already tried running the Vivo Y28 5G device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your Vivo Y28 5G’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the Vivo Y28 5G device turns off.
...
****Step 2:**** When the Vivo Y28 5G device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the Vivo Y28 5G device.
...
****Step 1:**** To force a restart, press and hold the Vivo Y28 5G device’s “Power” button for an extended period.
...
****Step 2:**** Connect your Vivo Y28 5G or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your Vivo Y28 5G, you must boot it into ****Download**** ****mode****. To boot your Vivo Y28 5G or tablet into DFU mode, follow the steps below:
...
1. Turn off the Vivo Y28 5G device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your Vivo Y28 5G. And in a while, your Vivo Y28 5G’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your Vivo Y28 5G 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.



## 4 Ways to Fix Android Blue Screen of Death On Vivo Y28 5G
...
## Part 1: How to rescue data on Vivo Y28 5G with blue screen of death?

The Android blue screen of death issue is not a difficult problem to deal with and can be fixed by you by following the easy steps given in this article. We suggest that all readers rescue the data stored on their Android devices to prevent data loss and keep it stored in your PC from where it can be accessed and recovered by you anytime, anywhere. This task might sound tedious, but, we have for you [Dr.Fone - Data Recovery (Android)](https://drfone.wondershare.com/android-data-recovery.html), a software specially designed to retrieve data from broken and damaged Vivo Y28 5G phones and tabs, especially Vivo Y28 5G devices, and keep it safe in your PC without tampering with it or altering its format. It efficiently extracts data from broken or unresponsive Vivo Y28 5G devices, phones/tabs stuck at black/blue screen, or whose system crashed due to a virus attack.
...
6\. In this step, refer to the instructions in your device manual to enter into Download Mode on your Vivo Y28 5G and hit “Next”. An example of what to do to reach Download Mode is shown below.
...
7\. Finally, let the software recognize your Vivo Y28 5G, and start to download the recovery package for your device.
...
This software effectively fixes Android screen of death issue along with app crashing, bricked or unresponsive device, stuck on Vivo Y28 5G logo, etc. All Android issues are well taken care of by Dr.Fone - System Repair (Android) with one click.
...
- All the latest Vivo Y28 5G devices are supported by this program.
...
Step 3: Over the Vivo Y28 5G device information window, select all relevant data about your device followed by the ‘Next’ button.
...
Step 1: Get the Vivo Y28 5G device in ‘Download’ mode to fix the **Android blue screen of death** issue. Here is how –

- On a ‘Home’ button-less device – you need to switch off the Vivo Y28 5G device. Now, hold the ‘Volume Down’, ‘Power’, and ‘Bixby’ keys together for about 10 seconds and release. Hit the ‘Volume Up’ key to get into ‘Download’ mode.
...
The best home remedy to fix any kind of Android screen of death remove the Vivo Y28 5G device’s battery. This technique might sound too simple, but it has solved the Android blue screen of death issue for many users whose devices started normally after reinserting the battery. Here is what you should do.

1\. Open the back cover of your Vivo Y28 5G and carefully remove its battery.
...
**Step:** Open the Settings app on your Vivo Y28 5G by locating and launching it. Proceed by scrolling through the options and selecting "Software Update." In the ensuing screen, choose "Download and Install" to start a search for any available updates.
...
Now use the power button to select it and wait for the Vivo Y28 5G device to reboot automatically.
...
Have you tried all the methods, and your Vivo Y28 5G is still stuck on the blue screen of death? In this case, it's important to consider the possibility of a hardware issue. Remember that hardware issues can be complex. Trying to fix things without the right expertise can result in additional harm. If you're uncertain about the next steps, it's wisest to ask for assistance from a trained professional.
...
## Android Safe Mode - How to Turn off Safe Mode on Vivo Y28 5G?
...
**Method 1: Restarting the Vivo Y28 5G device**

This is the easiest method to turn off the safe mode in Android. To use this method, follow the steps below.

Step 1 – Tap and hold the power button of your Vivo Y28 5G.

Step 2 – You could find the option “Restart”. Tap on it. (If you have only one option, move to the step no 2)

Step 3 – Now, your phone will boot up in some time and you can see the Vivo Y28 5G device is no more on safe mode.

![the Vivo Y28 5G device](https://images.wondershare.com/drfone/article/2017/06/14986725432763.jpg)
...
This time you can see your phone is no more in safe mode. Also, your junk files have been also removed. If you still find the Vivo Y28 5G device is the safe mode, follow the next method.
...
Step 1 – Take the back cover off from the Vivo Y28 5G device and remove the battery. (Not all devices will give you this facility)

Step 2 – Take out the SIM card.

Step 3 – Reinsert the SIM card and insert the battery again.

Step 4 – Turn the Vivo Y28 5G device on by tapping and holding the power button.

Now, you can see your device is out of safe mode. If you still find your device in Safe mode, see the next method.

**Method 4: Wipe the cache of the Vivo Y28 5G device.**

The cache of the Vivo Y28 5G device sometimes creates an obstacle in overcoming the safe mode on Android. To solve this issue, follow the steps below.
...
Before this, remember to take a backup of your Vivo Y28 5G. We recommend you to use the Dr.Fone - Phone Backup (Android). This tool is the best in its class to provide users with a very easy-to-use user interface yet powerful solution.
...
If you are using Android version 4.2 or earlier, turn off the Vivo Y28 5G device and turn it on the back by tapping the power button. When the logo appears, tap and hold the volume down button. This will allow the Vivo Y28 5G device to boot in safe mode.
...
**1\. Why is My Vivo Y28 5G on safe mode?**
...
**2\. Safe mode won't turn off on My Vivo Y28 5G**
...
<li><a href="https://iphone-unlock.techidaily.com/in-2024-7-top-ways-to-resolve-apple-id-not-active-issue-for-iphone-11-pro-drfone-by-drfone-ios/"><u>In 2024, 7 Top Ways To Resolve Apple ID Not Active Issue For iPhone 11 Pro | Dr.fone</u></a></li>
<li><a href="https://ai-vdieo-software.techidaily.com/mac-video-editing-software-expert-reviews-and-comparisons/"><u>Mac Video Editing Software Expert Reviews and Comparisons</u></a></li>
...
<li><a href="https://ai-video-apps.techidaily.com/new-in-2024-slow-down-or-freeze-time-expert-fcpx-editing-techniques/"><u>New In 2024, Slow Down or Freeze Time Expert FCPX Editing Techniques</u></a></li>

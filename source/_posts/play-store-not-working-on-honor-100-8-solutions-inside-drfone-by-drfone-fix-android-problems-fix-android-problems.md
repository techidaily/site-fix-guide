---
title: Play Store Not Working On Honor 100? 8 Solutions Inside | Dr.fone
date: 2024-04-30T14:29:21.471Z
updated: 2024-05-01T14:29:21.471Z
tags: 
  - problems
categories:
  - android
description: This article describes Play Store Not Working On Honor 100? 8 Solutions Inside
excerpt: This article describes Play Store Not Working On Honor 100? 8 Solutions Inside
keywords: Honor 100 android help,Honor 100 android issues,Honor 100 android support,android support,android solutions,fix android problems
thumbnail: https://www.lifewire.com/thmb/7wWwLeV8KAaB-XqPIbKe8lIgaY4=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/reddit-app-for-andoird-652f6fcd646245e9807afbac25a072ee.jpg
---

## Play Store Not Working On Honor 100? 8 Solutions Inside
...
- **Network issues.**Unstable or poor internet connections can disrupt the communication between the Honor 100 device and the Play Store. It can lead to frequent crashes.
...
- **Step 2:** Launch the program and connect your Honor 100 to the computer using a USB cable. Choose the Honor 100 device type and click **Start** to initiate the repair process.
...
- **Step 4:** Simply click **Done** on the prompt window displaying a confirmation message to exit the tool if your Honor 100 starts successfully. In the event that the Honor 100 device fails to start, select **Try Again** to initiate the process once more.
...
- Incorporates with 1-click technology to resolve any issues occurring in your Honor 100. Black screen of death, app crash, system crash, faulty issues etc.
...
Just follow the on-screen steps for booting your Honor 100 into download mode. Then, hit the “Next” button to proceed with downloading the most suitable firmware package for your Honor 100.
...
Now, your device will quickly reboot the Honor 100 device. Once, the Honor 100 device regains its normal state, check whether the issue is coming again or not.

### 2.2 Clear cache and data of Contacts app

The cache memory basically stashes the copies of the concerned application. It is indeed a streak of copies of the desired app storing information and incurring additional space on the storage. This might be the reason why the contact app crashes rapidly on your Honor 100. Hence, it can prove to be a good remedy for this problem. Just follow down the steps mentioned below-
...
As we know the cache memories are the temporary files build by the firmware. These are of little importance as they are bound to become a bit more corrupted in nature. And sometimes, may indirectly become a hurdle for the working of contacts app. It is good if the Honor 100 device is cleared off from the caches. Instead of manually wiping down the cache memory, we will understand how to clear off the cache partition in the following steps.
...
7. After, the process is through there will be an option for “Reboot System Now”. Tap on it and restart the Honor 100 device.
...
1. First of all, visit “Settings” from your Honor 100.
...
- Launch “Settings” app and surf for “Apps” or “Applications” option on your Honor 100.
...
- On your Honor 100, just go to “Home” screen and tap on “Apps” icon.

---
title: How To Fix Part of the Touch Screen Not Working on Vivo S18 | Dr.fone
date: 2024-04-30T14:18:24.018Z
updated: 2024-05-01T14:18:24.018Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Part of the Touch Screen Not Working on Vivo S18
excerpt: This article describes How To Fix Part of the Touch Screen Not Working on Vivo S18
keywords: android repair,Vivo S18 android repair,Vivo S18 android solutions,android fix,android problems,Vivo S18 android guide
thumbnail: https://www.lifewire.com/thmb/1X3sRGX1kbV-Ydn8ceXfqTlOH6I=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/african-american-woman-opening-packages-of-shoes-on-sofa-580503483-5a735094d8fdd50036b63f8a.jpg
---

## How To Fix Part of the Touch Screen Not Working on Vivo S18

You probably touch the screen of your phone hundreds of times per day. It’s no surprise that smartphone touchscreens are one of the most common components to fail, given their delicate glass construction. However, a ****part of the touch screen not working**** on your Vivo S18 does not necessarily mean it is a hardware issue. There could be other reasons why your Android’s touch screen stopped responding.
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the Vivo S18 device may be experiencing technical difficulties.
...
- Vivo S18 P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- Vivo S18 ****left side of the screen is not working****
...
- Remove the Vivo S18 device cover and screen protector if they are not damaged.
- If there is a sticker on the Vivo S18 device screen, you must remove it.
...
If you have already tried running the Vivo S18 device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your Vivo S18’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the Vivo S18 device turns off.
...
****Step 2:**** When the Vivo S18 device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the Vivo S18 device.
...
****Step 1:**** To force a restart, press and hold the Vivo S18 device’s “Power” button for an extended period.
...
****Step 2:**** Connect your Vivo S18 or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your Vivo S18, you must boot it into ****Download**** ****mode****. To boot your Vivo S18 or tablet into DFU mode, follow the steps below:
...
1. Turn off the Vivo S18 device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your Vivo S18. And in a while, your Vivo S18’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your Vivo S18 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.



## 4 Ways to Fix Android Blue Screen of Death On Vivo S18
...
## Part 1: How to rescue data on Vivo S18 with blue screen of death?

The Android blue screen of death issue is not a difficult problem to deal with and can be fixed by you by following the easy steps given in this article. We suggest that all readers rescue the data stored on their Android devices to prevent data loss and keep it stored in your PC from where it can be accessed and recovered by you anytime, anywhere. This task might sound tedious, but, we have for you [Dr.Fone - Data Recovery (Android)](https://drfone.wondershare.com/android-data-recovery.html), a software specially designed to retrieve data from broken and damaged Vivo S18 phones and tabs, especially Vivo S18 devices, and keep it safe in your PC without tampering with it or altering its format. It efficiently extracts data from broken or unresponsive Vivo S18 devices, phones/tabs stuck at black/blue screen, or whose system crashed due to a virus attack.
...
- Compatible with Vivo S18 devices.
...
6\. In this step, refer to the instructions in your device manual to enter into Download Mode on your Vivo S18 and hit “Next”. An example of what to do to reach Download Mode is shown below.
...
7\. Finally, let the software recognize your Vivo S18, and start to download the recovery package for your device.
...
This software effectively fixes Android screen of death issue along with app crashing, bricked or unresponsive device, stuck on Vivo S18 logo, etc. All Android issues are well taken care of by Dr.Fone - System Repair (Android) with one click.
...
- All the latest Vivo S18 devices are supported by this program.
...
Step 3: Over the Vivo S18 device information window, select all relevant data about your device followed by the ‘Next’ button.
...
Step 1: Get the Vivo S18 device in ‘Download’ mode to fix the **Android blue screen of death** issue. Here is how –

- On a ‘Home’ button-less device – you need to switch off the Vivo S18 device. Now, hold the ‘Volume Down’, ‘Power’, and ‘Bixby’ keys together for about 10 seconds and release. Hit the ‘Volume Up’ key to get into ‘Download’ mode.
...
The best home remedy to fix any kind of Android screen of death remove the Vivo S18 device’s battery. This technique might sound too simple, but it has solved the Android blue screen of death issue for many users whose devices started normally after reinserting the battery. Here is what you should do.

1\. Open the back cover of your Vivo S18 and carefully remove its battery.
...
**Step:** Open the Settings app on your Vivo S18 by locating and launching it. Proceed by scrolling through the options and selecting "Software Update." In the ensuing screen, choose "Download and Install" to start a search for any available updates.
...
Now use the power button to select it and wait for the Vivo S18 device to reboot automatically.
...
Have you tried all the methods, and your Vivo S18 is still stuck on the blue screen of death? In this case, it's important to consider the possibility of a hardware issue. Remember that hardware issues can be complex. Trying to fix things without the right expertise can result in additional harm. If you're uncertain about the next steps, it's wisest to ask for assistance from a trained professional.
...
## Fix Can't Take Screenshot Due to Security Policy on Vivo S18
...
Say you’re trying to take a screenshot on your Vivo S18 device, and you get the notification “**Can’t take screenshot due to security policy.” Vivo S18** smartphones are not necessarily the problem.
...
Sudden “**can’t take screenshot due to security policy**” notifications, failing to take a screenshot, and a Vivo S18 user?
...
- **Step 3:** Enable **Vivo S18 capture**.
...
- **Step 1:** Open Chrome on your Vivo S18 and type “chrome://flags” in the address bar.
...
With Google Assistant, taking screenshots on your Vivo S18 is now easier than ever. Just say, “Hey, Google, take a screenshot,” Google Assistant will capture the screen and save it to your gallery.
...
Smart View allows you to display your Vivo S18 device’s screen on your smart TV, where you can then take a screenshot of the TV to capture the app or website you need.
...
Alternatively, if you don’t have a smart TV, you can still mirror your phone screen display to your desktop or tablet using the Vivo S18 Flow app and take a screenshot of your phone’s screen instead.
...
- **Step 1:** Once you have downloaded Dr.Fone, install it and launch it on your desktop. Then, connect your Vivo S18 to your desktop using a USB cable.
...
- **Step 5:** Follow the in-app instructions to put your Vivo S18 on Download mode, then click **Next**.

---
title: My Videos Arent Playing on Lenovo ThinkPhone – What Can I Do? | Dr.fone
date: 2024-07-14T06:42:49.036Z
updated: 2024-07-15T06:42:49.036Z
tags: 
  - problems
categories:
  - android
description: This article describes My Videos Arent Playing on Lenovo ThinkPhone – What Can I Do?
excerpt: This article describes My Videos Arent Playing on Lenovo ThinkPhone – What Can I Do?
keywords: android problems,fix android problems,Lenovo ThinkPhone android help,android troubleshooting,android issues,android support,Lenovo ThinkPhone android tips
thumbnail: https://thmb.techidaily.com/2ca46c2a129dc1360b713c04a30f75e3e36c2cb0f971400d44a0a7430d69515d.jpg
---

## My Videos Aren't Playing on Lenovo ThinkPhone – What Can I Do?
...
You may encounter **videos not playing on your Lenovo ThinkPhone** more frequently than you like. Whether it’s video files you’ve recorded using your phone or files you’ve downloaded, this glitch can get pretty annoying pretty fast. Fortunately, there are several solutions you could try to fix it.
...
### 2. Restart Your Lenovo ThinkPhone
...
Fast, efficient, and powerful, Wondershare Dr.Fone can repair your Lenovo ThinkPhone in several simple steps:

- **Step 1**: Download and launch Wondershare Dr.Fone on your PC.
- **Step 2**: Go to **Toolbox**, then use a cable to connect your Lenovo ThinkPhone to your PC.
...
If the reason your videos wouldn’t play on your Lenovo ThinkPhone was a fault in the OS, everything should be functioning well after repairing your phone with Wondershare Dr.Fone.
...
If you still have issues with videos not playing on your Lenovo ThinkPhone, you could try deleting and reinstalling your video apps. Sometimes, simply updating the video app might still retain the glitch causing problems. However, if you delete it in its entirety and then install it again, the issue should be gone.
...
## Bricked Your Lenovo ThinkPhone? Here’s A Full Solution
...
If your device is completely unresponsive, don’t worry Dr.Fone can help you get all the data back. Simply follow these steps to gain access to the Lenovo ThinkPhone device and recover all your data.
...
Step 3: In the next step, you need to select your device model. If you don’t know the model of your device click on “How to check the Lenovo ThinkPhone device model” to get help.
...
Step 4: The next screen will provide instructions on how to enter “Download mode.” Connect the Lenovo ThinkPhone device to your PC once it is in “Download Mode”
...
### When the Lenovo ThinkPhone device Boots Straight into Recovery

If the Lenovo ThinkPhone device can boot to the recovery screen, you can find an alternative ROM to install and copy it your device. Installation can then be done in the recovery menu. If the Lenovo ThinkPhone device is booting to recovery mode there is a chance that it can be fixed.
...
### When the Lenovo ThinkPhone device won’t stop rebooting

Here’s what to do if the Lenovo ThinkPhone device wont stop rebooting.

Step 1: Turn off the Lenovo ThinkPhone device and then reboot in recovery mode.
...
Step 6: Finally reboot the Lenovo ThinkPhone device by selecting “Reboot system now.” This should fix the problem. You may also want to flash the same ROM or try a new one.
...
If all else fails, it is time to returning the Lenovo ThinkPhone device to the vendor if your warranty is still applicable.

## Part 3: Useful Tips to avoid Bricking your Android Phone

If you are planning on installing custom ROM you need to install Custom Recovery. This will enable you restore the Lenovo ThinkPhone device to its original settings should anything go wrong and hopefully help you avoid bricking your device.

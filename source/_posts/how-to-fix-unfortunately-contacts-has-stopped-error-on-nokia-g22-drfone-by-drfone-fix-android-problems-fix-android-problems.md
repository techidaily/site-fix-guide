...
date: 2024-07-14T05:52:55.224Z
updated: 2024-07-15T05:52:55.224Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix Unfortunately, Contacts Has Stopped Error on Nokia G22
excerpt: This article describes How to Fix Unfortunately, Contacts Has Stopped Error on Nokia G22
keywords: fix android problems,Nokia G22 android solutions,android troubleshooting,Nokia G22 android guide,Nokia G22 fix android problems,Nokia G22 android repair,Nokia G22 android issues,android issues,android support,android help,android guide,android solutions
thumbnail: https://thmb.techidaily.com/3b3d53f3a3456319783aa99ca770516fad2e58dbe2bd45f2ec6f3eb305fb3d58.png
---

## How to Fix Unfortunately, Contacts Has Stopped Error on Nokia G22

Have you recently noticed a message stating “Contacts has stopped”? This is enough to take away all your peace. As, our native contacts app stashes all our useful contacts which are time and again needed by a user. It’s malfunctioning is enough to give us chills. But, why the Nokia G22 or any other Android device incurs such problems?
...
- Incorporates with 1-click technology to resolve any issues occurring in your Nokia G22. Black screen of death, app crash, system crash, faulty issues etc.
...
Just follow the on-screen steps for booting your Nokia G22 into download mode. Then, hit the “Next” button to proceed with downloading the most suitable firmware package for your Nokia G22.
...
Now, your device will quickly reboot the Nokia G22 device. Once, the Nokia G22 device regains its normal state, check whether the issue is coming again or not.

### 2.2 Clear cache and data of Contacts app

The cache memory basically stashes the copies of the concerned application. It is indeed a streak of copies of the desired app storing information and incurring additional space on the storage. This might be the reason why the contact app crashes rapidly on your Nokia G22. Hence, it can prove to be a good remedy for this problem. Just follow down the steps mentioned below-
...
As we know the cache memories are the temporary files build by the firmware. These are of little importance as they are bound to become a bit more corrupted in nature. And sometimes, may indirectly become a hurdle for the working of contacts app. It is good if the Nokia G22 device is cleared off from the caches. Instead of manually wiping down the cache memory, we will understand how to clear off the cache partition in the following steps.
...
7. After, the process is through there will be an option for “Reboot System Now”. Tap on it and restart the Nokia G22 device.
...
1. First of all, visit “Settings” from your Nokia G22.
...
- Launch “Settings” app and surf for “Apps” or “Applications” option on your Nokia G22.
...
- On your Nokia G22, just go to “Home” screen and tap on “Apps” icon.
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the Nokia G22 device may be experiencing technical difficulties.
...
- Nokia G22 P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- Nokia G22 ****left side of the screen is not working****
...
- Remove the Nokia G22 device cover and screen protector if they are not damaged.
- If there is a sticker on the Nokia G22 device screen, you must remove it.
...
If you have already tried running the Nokia G22 device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your Nokia G22’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the Nokia G22 device turns off.
...
****Step 2:**** When the Nokia G22 device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the Nokia G22 device.
...
****Step 1:**** To force a restart, press and hold the Nokia G22 device’s “Power” button for an extended period.
...
****Step 2:**** Connect your Nokia G22 or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your Nokia G22, you must boot it into ****Download**** ****mode****. To boot your Nokia G22 or tablet into DFU mode, follow the steps below:
...
1. Turn off the Nokia G22 device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your Nokia G22. And in a while, your Nokia G22’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your Nokia G22 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.

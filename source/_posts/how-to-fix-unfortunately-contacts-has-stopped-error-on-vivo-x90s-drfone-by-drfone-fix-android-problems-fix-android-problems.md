...
date: 2024-07-14T05:55:25.242Z
updated: 2024-07-15T05:55:25.242Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix Unfortunately, Contacts Has Stopped Error on Vivo X90S
excerpt: This article describes How to Fix Unfortunately, Contacts Has Stopped Error on Vivo X90S
keywords: android tips,android support,Vivo X90S android issues,fix android problems,Vivo X90S android fix,Vivo X90S android tips,Vivo X90S android support
thumbnail: https://thmb.techidaily.com/271cc892260da7f0b1d8f207b3fb271cd7c70ce8ff0fa954ebc9cead95a6f721.jpg
---

## How to Fix Unfortunately, Contacts Has Stopped Error on Vivo X90S

Have you recently noticed a message stating “Contacts has stopped”? This is enough to take away all your peace. As, our native contacts app stashes all our useful contacts which are time and again needed by a user. It’s malfunctioning is enough to give us chills. But, why the Vivo X90S or any other Android device incurs such problems?
...
- Incorporates with 1-click technology to resolve any issues occurring in your Vivo X90S. Black screen of death, app crash, system crash, faulty issues etc.
...
Just follow the on-screen steps for booting your Vivo X90S into download mode. Then, hit the “Next” button to proceed with downloading the most suitable firmware package for your Vivo X90S.
...
Now, your device will quickly reboot the Vivo X90S device. Once, the Vivo X90S device regains its normal state, check whether the issue is coming again or not.

### 2.2 Clear cache and data of Contacts app

The cache memory basically stashes the copies of the concerned application. It is indeed a streak of copies of the desired app storing information and incurring additional space on the storage. This might be the reason why the contact app crashes rapidly on your Vivo X90S. Hence, it can prove to be a good remedy for this problem. Just follow down the steps mentioned below-
...
As we know the cache memories are the temporary files build by the firmware. These are of little importance as they are bound to become a bit more corrupted in nature. And sometimes, may indirectly become a hurdle for the working of contacts app. It is good if the Vivo X90S device is cleared off from the caches. Instead of manually wiping down the cache memory, we will understand how to clear off the cache partition in the following steps.
...
7. After, the process is through there will be an option for “Reboot System Now”. Tap on it and restart the Vivo X90S device.
...
1. First of all, visit “Settings” from your Vivo X90S.
...
- Launch “Settings” app and surf for “Apps” or “Applications” option on your Vivo X90S.
...
- On your Vivo X90S, just go to “Home” screen and tap on “Apps” icon.
...
## How to Fix It: Vivo X90S Won't Turn On

Did your Vivo X90S decide to go on vacation and refuses to turn on? If your Vivo X90S won’t turn on for no apparent reason, finding why it failed to power on and the solution for it is not a fun process.
...
## Part 1: Common Reasons That Your Vivo X90S Won't Turn On

If you cannot find any reason why your Vivo X90S will not switch on, here are some possible reasons:
...
3. The operating system or installed software is corrupted. The tell-tale sign if this is that if you manage to switch on your Vivo X90S, it freezes or crash soon after.
...
If your Vivo X90S won’t turn on, here is how you can use the software to recover data:

**Step 1: Launch [Wondershare Dr.Fone](https://tools.techidaily.com/wondershare/drfone/phone-switch/)**

On your desktop computer or laptop, open Wondershare Dr.Fone. Click on Data Recovery on the left column. Connect your Vivo X90S to the computer using a USB cable.
...
Look up for your device – pick the Vivo X90S device Name and Device Model. Advance by clicking on the Next button.
...
**Step 4: Go into your Vivo X90S’s Download Mode.**

The data recovery tool will guide you on how you can go into your Vivo X90S’s Download Mode. You should be getting a step-by-step guide on your computer.
...
Using the provided USB cable, attach your Vivo X90S to your computer – the data recovery tool should be able to discover your device automatically and scan it for recoverable data.
...
- This tool is aptly effective for all the latest Vivo X90S devices.
...
**Phase 1: Get the Vivo X90S device ready and connect it**
...
Step 3: Now, over the Vivo X90S device information window, ensure to feed your exact device details. Press the ‘Next’ button then on.

![go to SMS to export text messages](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

**Phase 2: Enter ‘Download’ mode for fixing your Vivo X90S**

Step 1: You need to put your Vivo X90S in Download mode for resolving the Android phone will not switch on.

- For the Vivo X90S device having ‘Home’ button, you got to switch it off and press ‘Volume Down’, ‘Home’, and ‘Power’ keys for 5-10 seconds at once. Let them go and click on the ‘Volume Up’ button to put your phone in ‘Download’ mode.
...
1. For any Android devices, remove the battery (considering the battery of your Vivo X90S can be removed) and leave it out for at least 30 minutes. Put back the battery in and try to turn it on.
2. Press and hold down the **Power** and **Volume Down** buttons at the same time for 15-30 minutes to reboot the Vivo X90S device.
3. Should the first two steps do not work, charge your Vivo X90S to get it out of the start-up loop. You can also opt to use a different battery, just in case your current battery is the source of the problem.
4. If there are any connected hardware e.g. SD card, remove them from the Vivo X90S device.
5. Start your Vivo X90S in **Safe Mode** by pressing and holding down the **Menu** or **Volume Down** button on your device.
...
7. Send your Vivo X90S to the repair shop should none of these steps work.

## Part 5: Useful Tips to Protect Your Vivo X90S

There are several reasons as to why your Vivo X90S won’t turn on. The problem could be a hardware or software issue which could be prevented. Here are some useful tips to protect your Vivo X90S.

**I. Hardware**

- Remember that the components that make your Vivo X90S is sensitive. To protect these components from being damaged, use a good guard casing.
- Take apart your Vivo X90S and clean it routinely to avoid dust and lint from clogging the phone and overheating it.
...
- Install reliable anti-virus and anti-malware software to safeguard your Vivo X90S from malicious attacks.
...
It is important to note that your phone contains some important data. Therefore, when your Vivo X90S won't turn on do not just give up - there are plenty of tools at your disposal to recover back your files and phone.
...
<li><a href="https://tiktok-clips.techidaily.com/updated-2024-approved-try-the-tiktok-craze-today-with-our-picks/"><u>[Updated] 2024 Approved  Try the TikTok Craze Today with Our Picks</u></a></li>

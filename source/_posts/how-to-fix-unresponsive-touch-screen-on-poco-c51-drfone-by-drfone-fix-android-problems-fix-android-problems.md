---
title: How To Fix Unresponsive Touch Screen on Poco C51 | Dr.fone
date: 2024-07-14T06:03:30.332Z
updated: 2024-07-15T06:03:30.332Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Unresponsive Touch Screen on Poco C51
excerpt: This article describes How To Fix Unresponsive Touch Screen on Poco C51
keywords: Poco C51 android issues,Poco C51 android support,android troubleshooting,android help,android guide,android issues,Poco C51 android solutions,android fix,fix android problems
...
## 11 Proven Solutions to Fix Google Play Store Not Working Issue on Poco C51
...
1. Activate the Download mode from your Poco C51.
...
1. The downloaded firmware will be loaded and flashed to your Poco C51 to fix the Google Play Store not working issue.
...
This may happen that sometimes Google Play Store stopped working due to excessive unnecessary data stored in the cache of the Poco C51 device. So, clearing unnecessary data is very important to keep the application run smoothly. To do this, you need to follow the below steps.
...
Google Play store can’t be uninstalled completed completely from your Poco C51. But disabling and reinstalling its latest version can resolve the Play Store crashing issue. For doing this, just follow the below guide.
...
Google Play Store needs to be restart just like your PC. This is a really helpful and common trick to overcome the Play Store crashing issue on your Poco C51. To do this, follow the below steps.

---
title: How to Quickly Fix Bluetooth Not Working on Infinix Smart 8 | Dr.fone
date: 2024-05-19T03:59:01.328Z
updated: 2024-05-20T03:59:01.328Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Quickly Fix Bluetooth Not Working on Infinix Smart 8
excerpt: This article describes How to Quickly Fix Bluetooth Not Working on Infinix Smart 8
keywords: android repair,android troubleshooting,android issues,fix android problems,android fix,Infinix Smart 8 android help,Infinix Smart 8 android troubleshooting,Infinix Smart 8 android issues
...
## How to Quickly Fix Bluetooth Not Working on Infinix Smart 8
...
Of course, the most common problem to occur with Bluetooth technology in your Infinix Smart 8 is when it doesn’t connect to the Infinix Smart 8 device you’re trying to link it to. This could be anything from a Bluetooth headset or headphones, to a portable speaker or even an in-car audio system.
...
**Step Two** Connect your Infinix Smart 8 to your computer using the USB cable, wait a couple of seconds, and then click the System Repair option. On the Menu on the left, click Android Repair, and then press Start.
...
When the repair process has been completed, you’ll receive the screen below, which means you can try again if the process didn’t work, or you can disconnect your Infinix Smart 8 and start using it and your Bluetooth features.
...
1. Turn your Infinix Smart 8 off by holding down the Power button
...
Every service on your Infinix Smart 8 using a feature called a cache. This is where information is stored to help the feature run properly and give you the best experience. However, over time this can get messy and can cause problems with your Bluetooth feature.
...
Sometimes, you may have a problem with the Infinix Smart 8 device you’re trying to connect to via Bluetooth, especially if this is a device you’ve updated. To counter and repair this, you’re going to need to remove the paired devices saved with your device and then reconnect them.

Here’s how;

1. From the Main Menu of your Infinix Smart 8, head to Settings > Bluetooth > Connected Devices.
2. Turn Bluetooth on, and you’ll see all the connections your Infinix Smart 8 is paired with
3. Go through these settings and remove/delete/forget every connection on your device
4. Now when you go to connect to a device using Bluetooth, repair the Infinix Smart 8 device, enter the passcode, and use a fresh paired connection.
...
If you’re having problems with your connection and paired devices, sometimes you may have conflicting software faults in your device that are causing the problems. If this is the case, you’ll need to boot your Infinix Smart 8 in Safe Mode.
...
4. Turn your Bluetooth feature on and connect to the Infinix Smart 8 device you’re trying to connect too
...
Sometimes, you might not even have a problem with your Infinix Smart 8, but rather the Bluetooth device you’re trying to connect to, whether that’s a Bluetooth speaker, an in-car entertainment system, or any other kind of Bluetooth device.
...
1. Disconnect your Infinix Smart 8 from the Bluetooth device and turn your Bluetooth off
2. Now take another Bluetooth device and connect this to the Infinix Smart 8 device you’re trying to connect too. This could be another Android device, or even a computer or iOS device
3. If the new device doesn’t connect to your Bluetooth device, you’ll know there’s a problem with your Bluetooth device, not your Infinix Smart 8
4. If the Infinix Smart 8 devices connect, you’ll know there’s a problem with your Infinix Smart 8
...
The further away the Infinix Smart 8 devices are from each other, the less likely the connection will remain secure. As a rule of thumb, Bluetooth can work up to 100 meters, but to play it safe, always try and keep your devices under 50m apart.
...
Say you’re trying to take a screenshot on your Infinix Smart 8 device, and you get the notification “**Can’t take screenshot due to security policy.” Infinix Smart 8** smartphones are not necessarily the problem.
...
Sudden “**can’t take screenshot due to security policy**” notifications, failing to take a screenshot, and a Infinix Smart 8 user?
...
- **Step 3:** Enable **Infinix Smart 8 capture**.
...
- **Step 1:** Open Chrome on your Infinix Smart 8 and type “chrome://flags” in the address bar.
...
With Google Assistant, taking screenshots on your Infinix Smart 8 is now easier than ever. Just say, “Hey, Google, take a screenshot,” Google Assistant will capture the screen and save it to your gallery.
...
Smart View allows you to display your Infinix Smart 8 device’s screen on your smart TV, where you can then take a screenshot of the TV to capture the app or website you need.
...
Alternatively, if you don’t have a smart TV, you can still mirror your phone screen display to your desktop or tablet using the Infinix Smart 8 Flow app and take a screenshot of your phone’s screen instead.
...
- **Step 1:** Once you have downloaded Dr.Fone, install it and launch it on your desktop. Then, connect your Infinix Smart 8 to your desktop using a USB cable.
...
- **Step 5:** Follow the in-app instructions to put your Infinix Smart 8 on Download mode, then click **Next**.

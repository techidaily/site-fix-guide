...
date: 2024-07-14T05:43:14.944Z
updated: 2024-07-15T05:43:14.944Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Part of the Touch Screen Not Working on Lenovo ThinkPhone
excerpt: This article describes How To Fix Part of the Touch Screen Not Working on Lenovo ThinkPhone
keywords: Lenovo ThinkPhone android troubleshooting,android help,Lenovo ThinkPhone android repair,Lenovo ThinkPhone android problems,android solutions,fix android problems,Lenovo ThinkPhone android help,android tips,android problems,Lenovo ThinkPhone android fix,android support
...
## App Won't Open on Your Lenovo ThinkPhone? Here Are All Fixes
...
Here are all the fixes you need if an App won’t open on your Lenovo ThinkPhone. Read on to find out all about why Apps won't open on your Lenovo ThinkPhone and solutions to overcome such a problem.
...
It is appropriate to tag our generation as smartphone addicts because we use smartphones for anything and everything. All our important information, such as photos, videos, audio files, documents, notes, calendars, emails, etc, are stored on our phones. This causes a major storage/space problem in our phones and **a shortage of storage space** is one of the main reasons why an App won’t open or why all Apps won't open on your Lenovo ThinkPhone. To see how much of your storage space is occupied by Apps, go to “Settings” and select “Application Manager”.
...
The causes for the problem to occur are many and no specific reason can be established as the only reason why Apps won't open on your Lenovo ThinkPhone. There are a lot of speculations about why such a problem occurs and persists, but it is more important to focus on how to fix if a particular App won't open or if all Apps won't open on Android.
...
- All the latest Lenovo ThinkPhone tablets and mobiles are compatible with it.
...
- The high success rate for Lenovo ThinkPhone Android device issue fixing.

**3981454** people have downloaded it

#### Here comes the detailed guide to fix apps won't open problem using Dr.Fone - System Repair (Android)

**Note:** _When you are up to fixing apps won't open issues, make sure to [back up your Lenovo ThinkPhone](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) beforehand. These processes might lead to data erasing and you don’t want to suffer data loss this way._
...
Step 3: Feed your Lenovo ThinkPhone details under the Lenovo ThinkPhone device information screen. Please check the warning and press the ‘Next’ button right after that.

![select the android info](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

**Phase 2: Repairing your Lenovo ThinkPhone under ‘Download’ mode**

Step 1: You got to boot the Android device under Download mode, as it’s important. The steps for that are as follows –

- Android devise with a ‘Home’ button – Press together ‘Volume Down’, ‘Home’, and ‘Power’ buttons together for 5 to 10 seconds after turning off the Lenovo ThinkPhone device. Release them afterward and click the ‘Volume Up’ button to get into the ‘Download’ mode.

![boot android in download mode with home key](https://images.wondershare.com/drfone/guide/android-system-repair-3.png)

- When there is no ‘Home’ button – Turn off the Lenovo ThinkPhone device and then for 5 to 10 seconds, keep the ‘Volume Down’, ‘Bixby’, and ‘Power’ buttons pressed. Tap the ‘Volume Up’ button after releasing all the buttons to enter the ‘Download’ mode.
...
• Visit Google Play Store on your Lenovo ThinkPhone.
...
• Click on “Apps” to see a list of all the Apps on your Lenovo ThinkPhone.
...
Restarting your Lenovo ThinkPhone to fix an error might sound old school but it gives good results when your Apps won't open. Restarting your phone is fairly simple. All you need to do is:
...
Your phone will automatically restart and once it does, you can try to launch the App. You may also restart your Lenovo ThinkPhone by pressing the power button for about 15-20 seconds.

3\. Reset Factory Settings

This method is a little tedious and must be last on your list. Also, make sure you take a backup of all your data and contents stored on your Lenovo ThinkPhone and this solution will completely wipe off your phone making as good as a new smartphone.

To Factory Reset your Lenovo ThinkPhone, carefully follow the guidelines given below:

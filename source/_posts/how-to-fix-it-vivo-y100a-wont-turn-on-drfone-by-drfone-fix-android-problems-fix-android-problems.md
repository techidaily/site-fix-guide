---
title: How to Fix It Vivo Y100A Wont Turn On | Dr.fone
date: 2024-07-14T05:41:25.002Z
updated: 2024-07-15T05:41:25.002Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix It Vivo Y100A Wont Turn On
excerpt: This article describes How to Fix It Vivo Y100A Wont Turn On
keywords: Vivo Y100A android guide,android solutions,Vivo Y100A android troubleshooting,Vivo Y100A fix android problems,Vivo Y100A android fix,android problems,android repair,android help,Vivo Y100A android help,Vivo Y100A android repair,android support
...
<!-- affiliate ads end -->
## Google Play Services Won't Update? 12 Fixes are Here on Vivo Y100A
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Vivo Y100A can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Vivo Y100A to the PC. Then hit on “Start”.
...
In most cases, restarting the Vivo Y100A device can simply do the trick. When you restart the Vivo Y100A device, most of the issues get eliminated making the Vivo Y100A device perform better than before. Also, it is all about RAM. While you restart your device, the RAM gets cleared. As a result, the apps work properly. So, in the first place, we would like you to restart your Vivo Y100A when you cannot update Google Play Services. Once restarted, try to update again and see if the results are positive.
...
If unfortunately, things are still the same, we would like to recommend you wipe the cache of the whole device to fix the issue. This is an advanced method to solve issues and is helpful when the Vivo Y100A device is facing any flaws or malfunctions. For this, you need to go to the download mode or recovery mode of your device. Every device has its own steps for this. Like in some, you need to simultaneously press the “Power” and “Volume Down” keys. While in some, the “Power” and both “Volume” keys work.
...
- Turn off the Vivo Y100A device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Vivo Y100A device will begin to wipe the cache.
- Hit reboot when asked and the Vivo Y100A device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Vivo Y100A device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Vivo Y100A device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Vivo Y100A, follow these steps:

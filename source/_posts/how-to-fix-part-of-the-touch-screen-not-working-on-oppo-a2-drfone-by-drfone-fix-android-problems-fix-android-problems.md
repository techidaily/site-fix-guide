...
date: 2024-07-14T05:44:01.212Z
updated: 2024-07-15T05:44:01.212Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Part of the Touch Screen Not Working on Oppo A2
excerpt: This article describes How To Fix Part of the Touch Screen Not Working on Oppo A2
keywords: android support,android help,android solutions,Oppo A2 android solutions,Oppo A2 android problems,Oppo A2 android tips,android problems
...
<!-- affiliate ads end -->
## Google Play Services Won't Update? 12 Fixes are Here on Oppo A2
...
- **1\. Incompatibility with Custom ROMs:** Using a custom ROM on your Oppo A2 can cause compatibility issues and prevent the installation of Google Play Services updates.
...
Now, taking the assistance of an original USB cable, connect your Oppo A2 to the PC. Then hit on “Start”.
...
- Turn off the Oppo A2 device to begin with and then follow the steps for recovery mode.
- On the recovery screen, use the “Volume” buttons for scrolling up and down and go to “Wipe cache partition”.
- To confirm, press the “Power” button. Now, the Oppo A2 device will begin to wipe the cache.
- Hit reboot when asked and the Oppo A2 device will now be rebooted finishing the issue.
...
Some devices aggressively optimize battery usage, which can interfere with the background processes required for updating Google Play Services. Disable battery optimization for Google Play Services in the Oppo A2 device's Settings to ensure uninterrupted updates.
...
As a final measure, if everything went in vain, you can perform a factory reset on your device. This method will wipe away all your data while performing and make the Oppo A2 device go to factory state. Please ensure to keep backing up your important data if you are going to take the help of this method.
...
To check the version of Google Play Services on your Oppo A2, follow these steps:

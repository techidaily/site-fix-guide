...
date: 2024-07-14T05:46:37.981Z
updated: 2024-07-15T05:46:37.981Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Fix Part of the Touch Screen Not Working on ZTE Axon 40 Lite
excerpt: This article describes How To Fix Part of the Touch Screen Not Working on ZTE Axon 40 Lite
keywords: android help,ZTE Axon 40 Lite android solutions,ZTE Axon 40 Lite android issues,android troubleshooting,android fix,android issues
thumbnail: https://thmb.techidaily.com/a7150b4ff2ea7550c12f390526178357d28d5879ccd1eca0b9ed1b9c559e12d9.jpg
---

## How To Fix Part of the Touch Screen Not Working on ZTE Axon 40 Lite

You probably touch the screen of your phone hundreds of times per day. It’s no surprise that smartphone touchscreens are one of the most common components to fail, given their delicate glass construction. However, a ****part of the touch screen not working**** on your ZTE Axon 40 Lite does not necessarily mean it is a hardware issue. There could be other reasons why your Android’s touch screen stopped responding.
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the ZTE Axon 40 Lite device may be experiencing technical difficulties.
...
- ZTE Axon 40 Lite P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- ZTE Axon 40 Lite ****left side of the screen is not working****
...
- Remove the ZTE Axon 40 Lite device cover and screen protector if they are not damaged.
- If there is a sticker on the ZTE Axon 40 Lite device screen, you must remove it.
...
If you have already tried running the ZTE Axon 40 Lite device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your ZTE Axon 40 Lite’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the ZTE Axon 40 Lite device turns off.
...
****Step 2:**** When the ZTE Axon 40 Lite device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the ZTE Axon 40 Lite device.
...
****Step 1:**** To force a restart, press and hold the ZTE Axon 40 Lite device’s “Power” button for an extended period.
...
****Step 2:**** Connect your ZTE Axon 40 Lite or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your ZTE Axon 40 Lite, you must boot it into ****Download**** ****mode****. To boot your ZTE Axon 40 Lite or tablet into DFU mode, follow the steps below:
...
1. Turn off the ZTE Axon 40 Lite device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your ZTE Axon 40 Lite. And in a while, your ZTE Axon 40 Lite’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your ZTE Axon 40 Lite 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.



## 7 Fixes for "Unfortunately, Phone Has Stopped" on ZTE Axon 40 Lite
...
First and foremost, the thing that can let you get rid of this trouble is Safe Mode. It is a feature that will end any excessive background functioning of the ZTE Axon 40 Lite device. For instance, your device will be able to run sans any third-party apps when in Safe mode. Since the important functions and the naïve apps will be running on the ZTE Axon 40 Lite device, you will get to know if it’s really a software glitch or not by running the Phone app in Safe mode. And this is the first solution we would recommend you make use of when the Phone app has stopped. Here is how to enable Safe Mode.

1. Switch off the ZTE Axon 40 Lite phone first.
2. Now keep pressing the "Power" button until you see the ZTE Axon 40 Lite logo on the screen.
3. Release the button and immediately press and hold the "Volume Down" key.
4. Leave the key once the ZTE Axon 40 Lite device is in Safe mode. Now, the third-party apps will be disabled and you can check if the Phone app is still not responding or everything is fine.
...
### 2.4 Update the ZTE Axon 40 Lite firmware

When the firmware is not updated, it may conflict with some apps and maybe that’s why your Phone app falls prey. Therefore, updating ZTE Axon 40 Lite firmware will be a sane step that should be taken when the Phone app has stopped. Follow the below-mentioned steps and then check if the Phone app is opening or not.
...
Here is another resolution for the "Unfortunately Phone has stopped" error. Clearing the partition cache will remove the whole cache of the ZTE Axon 40 Lite device and make it work like before.
...
5. The process will begin and the ZTE Axon 40 Lite device will restart post it. Check if the problem still persists or it is finished. If unfortunately not, get to the next and the most productive solution.
...
### 2.6 Get the ZTE Axon 40 Lite system repaired in one click
...
Android repair tool to fix "Unfortunately, Phone Has Stopped" on ZTE Axon 40 Lite devices.

- It takes no special skills to operate it and fairly works to bring the Android system to normalcy.
- It shows great compatibility with all ZTE Axon 40 Lite devices and other Android phones supporting over 1000 Android brands.
...
Take your original USB cord and then connect your ZTE Axon 40 Lite to the computer. When the ZTE Axon 40 Lite device is connected, click on "Android" from the two tabs > click "Start"

![Phone app crashing - connect phone to pc](https://images.wondershare.com/drfone/guide/android-system-repair-1.png)

**Step 3: Enter the Details**

As the next step, enter some important details on the next screen. Be sure to enter the right name, brand, and model of the ZTE Axon 40 Lite device. When done everything, verify once and click on "Next".
...
**Step 5: Get the ZTE Axon 40 Lite device Repaired**

When you see the firmware has been downloaded, the issue will begin to get resolved. Hang on and wait until you get notified for the repair of the ZTE Axon 40 Lite device.
...
## Fix Unfortunately Settings Has Stopped on ZTE Axon 40 Lite Quickly

All of you, sooner or later, must have found the “Unfortunately Settings has stopped” error on your ZTE Axon 40 Lite. The problem can occur if the Settings keeps stopping or crashing. Many times, you may try to open the Settings but it doesn’t even open. Or possibly, it may freeze after getting opened thereby hampering the ZTE Axon 40 Lite device's performance.
...
Well! There can be a number of reasons why this thing happens. For instance, custom ROM installations, not enough space in the ZTE Axon 40 Lite device or perhaps an outdated version of Android. If you are struggling with the same issue and want to know what to do when Android Settings is not responding, this post will help you. We have explained everything in detail along with the solutions. So, scroll down and get things sorted.
...
1. Open “Settings” on your ZTE Axon 40 Lite and choose “Apps & Notifications”/”Apps”/”Application Manager” (the option may differ on different devices).
...
Using a custom ROM on your device brings up this problem due to incompatibility or improper installation. Therefore, you should either uninstall the custom ROM or re-flash the stock ROM. in order to re-flash the stock ROM of your ZTE Axon 40 Lite, the best way would be Dr.Fone - System Repair (Android). It offers one-click functionality to flash stock ROM and that too with full security. Supporting all ZTE Axon 40 Lite devices, it ranks among its counterparts when it comes to fixing crashing Phone app issues or any other Android system issue. It is loaded with the beneficial features which are discussed below.
...
With the help of a USB cable, plug your ZTE Axon 40 Lite into the PC. Upon proper connection, hit on the “Android Repair” option from the left panel.
...
Once the firmware is completely downloaded, your ZTE Axon 40 Lite will automatically start getting repaired. Stay there and you will receive a notification that the repair is done.
...
5. Once finished, click the reboot option and the ZTE Axon 40 Lite device will be rebooted, fixing the issue hopefully.
...
You can also opt for Factory resetting your device to fix the issue of Settings keeps stopping. By removing everything from the ZTE Axon 40 Lite device, it will make your device run properly. If you have important data on your device, please make sure to [create a backup](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) before taking action if you don’t want to lose it. The steps are as follows.
...
If your ZTE Axon 40 Lite shows the "Unfortunately Settings has stopped" error, don't worry. This problem can come from many things like old software or cache issues. You can try easy fixes like clearing cache or updating your system. Sometimes, removing custom ROMs might be needed.
...
<li><a href="https://tiktok-videos.techidaily.com/new-the-secret-to-staying-spotlight-ready-on-tiktok-for-2024/"><u>[New] The Secret to Staying Spotlight-Ready on TikTok for 2024</u></a></li>
...
<li><a href="https://video-creation-software.techidaily.com/updated-take-your-videos-to-the-next-level-3d-effects-tutorial-for-windows-users-for-2024/"><u>Updated Take Your Videos to the Next Level 3D Effects Tutorial for Windows Users for 2024</u></a></li>
<li><a href="https://sound-tweaking.techidaily.com/in-2024-the-definitive-list-of-advanced-audio-moderation-programs/"><u>In 2024, The Definitive List of Advanced Audio Moderation Programs</u></a></li>

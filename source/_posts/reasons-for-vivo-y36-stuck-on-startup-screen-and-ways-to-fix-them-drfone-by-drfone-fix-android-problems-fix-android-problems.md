---
title: Reasons for Vivo Y36 Stuck on Startup Screen and Ways To Fix Them | Dr.fone
date: 2024-09-05T22:46:20.916Z
updated: 2024-09-06T22:46:20.916Z
tags: 
  - problems
categories:
  - android
description: This article describes Reasons for Vivo Y36 Stuck on Startup Screen and Ways To Fix Them
excerpt: This article describes Reasons for Vivo Y36 Stuck on Startup Screen and Ways To Fix Them
keywords: android guide,android tips,Vivo Y36 android support,android help,Vivo Y36 fix android problems,android troubleshooting,Vivo Y36 android solutions,android fix,Vivo Y36 android guide,Vivo Y36 android issues,Vivo Y36 android tips
...
<!-- affiliate ads end -->
## Reasons for Vivo Y36 Stuck on Startup Screen and Ways To Fix Them
...
Here is an example of performing a hard reboot for an Android phone such as Vivo Y36. Preess and hold the Power and Volume Down buttons simultaneously for more than 7 seconds to perform the hard reboot.
...
Here is a step-by-step process for putting your Vivo Y36 or Redmi smartphone in recovery mode.

****Step 1****: Tap and press the Power button to switch off your Vivo Y36/Redmi phone
...
![Vivo Y36 reset button](https://images.wondershare.com/drfone/article/2023/03/reasons-for-phones-stuck-on-startup-screen-and-ways-to-fix-them-06.jpg)

**Note:** Before carrying out a factory reset, you need to input the password of your Vivo Y36 Account.
...
****Step 2:**** Depending on the Vivo Y36 device you are using, choose either ****Android**** or ****iPhone****.
...
In a rooted device, changes made, such as flashing a new ROM or customized firmware which are not compatible with the Vivo Y36 device’s hardware or existing software, can be blamed for the boot loop problem.
...
Hence, if you are looking for ways to guide you about how to fix boot loop issue, you will have to revamp the Vivo Y36 device internally by either resetting it or adopting a recovery method.
...
- Works with most Vivo Y36 devices, including the latest Vivo Y36 phones like S22
...
<!-- affiliate ads end -->
**Step #2** Connect your Vivo Y36 to your computer using the official cable and select the "Android" option from the three menu items. Click "Start" to confirm.
...
<!-- affiliate ads end -->
You’ll then need to input the Vivo Y36 device information, such as your carrier info, device name, model, and country/region in order to ensure you’re downloading and repairing the correct firmware to your phone.
...
Turn the Vivo Y36 device off and take out its battery.
...
In case the Vivo Y36 device does not turn on normally and is still stuck in the bootloop Android problem, be prepared to use the troubleshooting techniques given and explained below.
...
Booting your Vivo Y36 into Safe Mode is a useful troubleshooting step to fix boot loop issues caused by third-party apps. When in Safe Mode, the Vivo Y36 device will start up with only essential system apps, and any downloaded apps that might be causing conflicts won't run. Here's how you can boot your Vivo Y36 into Safe Mode to address the boot loop problem:
...
- For most Android devices: Press and hold the power button to turn on your device. As soon as the manufacturer's logo appears, press and hold the Volume Down button until the Vivo Y36 device finishes booting. You should see "Safe Mode" displayed in the bottom left or right corner of the screen.
...
**Step 3: Observe the Vivo Y36 device**
...
By following these steps and using Safe Mode to isolate problematic apps, you can effectively troubleshoot and resolve boot loop issues on your Vivo Y36.
...
Please note that all your device’s data and settings will be deleted by adopting this method. However, if you have a Google account signed in on your Vivo Y36, you will be able to retrieve most of your data once the Vivo Y36 device turns on.
...
This solution is known to fix the boot loop error 9 out of 10 times, but if you still can't start your Vivo Y36 normally, consider using a CWM Recovery to resolve the Android boot loop issue.
...
CWM stands for ClockworkMod and it is a very popular custom recovery system. To use this system to solve the boot loop Android error, your Vivo Y36 must be rooted with CWM Recovery System which basically means CWM must be downloaded and installed on your device.
...
Once this is done, make sure to reboot your Vivo Y36.
...
An Android boot loop is a common phenomenon with all Android devices because we tend to tamper with our device’s internal settings. Once the ROM, firmware, kernel, etc are damaged or rendered incompatible with the Vivo Y36 device’s software, you cannot expect it to function smoothly, hence, the boot loop error occurs. Since you are not the only one suffering from the Android boot loop problem, be rest assured that the ways, given above, to combat it are recommended by users facing similar troubles. So, don't hesitate and go ahead to try them on.

![safe Download](https://images.wondershare.com/drfone/security.svg) safe & secure

## How to Fix Unfortunately, Contacts Has Stopped Error on Vivo Y36

Have you recently noticed a message stating “Contacts has stopped”? This is enough to take away all your peace. As, our native contacts app stashes all our useful contacts which are time and again needed by a user. It’s malfunctioning is enough to give us chills. But, why the Vivo Y36 or any other Android device incurs such problems?
...
- Incorporates with 1-click technology to resolve any issues occurring in your Vivo Y36. Black screen of death, app crash, system crash, faulty issues etc.
...
Just follow the on-screen steps for booting your Vivo Y36 into download mode. Then, hit the “Next” button to proceed with downloading the most suitable firmware package for your Vivo Y36.
...
Now, your device will quickly reboot the Vivo Y36 device. Once, the Vivo Y36 device regains its normal state, check whether the issue is coming again or not.
...
The cache memory basically stashes the copies of the concerned application. It is indeed a streak of copies of the desired app storing information and incurring additional space on the storage. This might be the reason why the contact app crashes rapidly on your Vivo Y36. Hence, it can prove to be a good remedy for this problem. Just follow down the steps mentioned below-
...
As we know the cache memories are the temporary files build by the firmware. These are of little importance as they are bound to become a bit more corrupted in nature. And sometimes, may indirectly become a hurdle for the working of contacts app. It is good if the Vivo Y36 device is cleared off from the caches. Instead of manually wiping down the cache memory, we will understand how to clear off the cache partition in the following steps.
...
<!-- affiliate ads end -->
7. After, the process is through there will be an option for “Reboot System Now”. Tap on it and restart the Vivo Y36 device.
...
1. First of all, visit “Settings” from your Vivo Y36.
...
- Launch “Settings” app and surf for “Apps” or “Applications” option on your Vivo Y36.
...
- On your Vivo Y36, just go to “Home” screen and tap on “Apps” icon.
...
<li><a href="https://phone-solutions.techidaily.com/in-2024-looking-for-a-location-changer-on-tecno-phantom-v-flip-look-no-further-drfone-by-drfone-virtual-android/"><u>In 2024, Looking For A Location Changer On Tecno Phantom V Flip? Look No Further | Dr.fone</u></a></li>

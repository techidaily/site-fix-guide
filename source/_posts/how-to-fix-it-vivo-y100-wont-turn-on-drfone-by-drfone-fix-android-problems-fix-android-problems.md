---
title: How to Fix It Vivo Y100 Wont Turn On | Dr.fone
date: 2024-07-14T05:41:23.812Z
updated: 2024-07-15T05:41:23.812Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix It Vivo Y100 Wont Turn On
excerpt: This article describes How to Fix It Vivo Y100 Wont Turn On
keywords: Vivo Y100 android guide,android help,android support,android solutions,Vivo Y100 android issues,Vivo Y100 android tips,android troubleshooting,Vivo Y100 android support,fix android problems,Vivo Y100 android help,Vivo Y100 android troubleshooting
thumbnail: https://thmb.techidaily.com/6a8b7b3cdb25a03e07ba1819bb3940ce3cb079bf3680cebd2f9e48a956c136d3.jpg
---

## How to Fix It: Vivo Y100 Won't Turn On

Did your Vivo Y100 decide to go on vacation and refuses to turn on? If your Vivo Y100 won’t turn on for no apparent reason, finding why it failed to power on and the solution for it is not a fun process.
...
## Part 1: Common Reasons That Your Vivo Y100 Won't Turn On

If you cannot find any reason why your Vivo Y100 will not switch on, here are some possible reasons:
...
3. The operating system or installed software is corrupted. The tell-tale sign if this is that if you manage to switch on your Vivo Y100, it freezes or crash soon after.
...
- Compatible with Vivo Y100 devices.

**3981454** people have downloaded it

If your Vivo Y100 won’t turn on, here is how you can use the software to recover data:

**Step 1: Launch [Wondershare Dr.Fone](https://tools.techidaily.com/wondershare/drfone/phone-switch/)**

On your desktop computer or laptop, open Wondershare Dr.Fone. Click on Data Recovery on the left column. Connect your Vivo Y100 to the computer using a USB cable.
...
Look up for your device – pick the Vivo Y100 device Name and Device Model. Advance by clicking on the Next button.
...
**Step 4: Go into your Vivo Y100’s Download Mode.**

The data recovery tool will guide you on how you can go into your Vivo Y100’s Download Mode. You should be getting a step-by-step guide on your computer.
...
Using the provided USB cable, attach your Vivo Y100 to your computer – the data recovery tool should be able to discover your device automatically and scan it for recoverable data.
...
- This tool is aptly effective for all the latest Vivo Y100 devices.
...
**Phase 1: Get the Vivo Y100 device ready and connect it**
...
Step 3: Now, over the Vivo Y100 device information window, ensure to feed your exact device details. Press the ‘Next’ button then on.

![go to SMS to export text messages](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

**Phase 2: Enter ‘Download’ mode for fixing your Vivo Y100**

Step 1: You need to put your Vivo Y100 in Download mode for resolving the Android phone will not switch on.

- For the Vivo Y100 device having ‘Home’ button, you got to switch it off and press ‘Volume Down’, ‘Home’, and ‘Power’ keys for 5-10 seconds at once. Let them go and click on the ‘Volume Up’ button to put your phone in ‘Download’ mode.
...
1. For any Android devices, remove the battery (considering the battery of your Vivo Y100 can be removed) and leave it out for at least 30 minutes. Put back the battery in and try to turn it on.
2. Press and hold down the **Power** and **Volume Down** buttons at the same time for 15-30 minutes to reboot the Vivo Y100 device.
3. Should the first two steps do not work, charge your Vivo Y100 to get it out of the start-up loop. You can also opt to use a different battery, just in case your current battery is the source of the problem.
4. If there are any connected hardware e.g. SD card, remove them from the Vivo Y100 device.
5. Start your Vivo Y100 in **Safe Mode** by pressing and holding down the **Menu** or **Volume Down** button on your device.
...
7. Send your Vivo Y100 to the repair shop should none of these steps work.

## Part 5: Useful Tips to Protect Your Vivo Y100

There are several reasons as to why your Vivo Y100 won’t turn on. The problem could be a hardware or software issue which could be prevented. Here are some useful tips to protect your Vivo Y100.

**I. Hardware**

- Remember that the components that make your Vivo Y100 is sensitive. To protect these components from being damaged, use a good guard casing.
- Take apart your Vivo Y100 and clean it routinely to avoid dust and lint from clogging the phone and overheating it.
...
- Install reliable anti-virus and anti-malware software to safeguard your Vivo Y100 from malicious attacks.
...
It is important to note that your phone contains some important data. Therefore, when your Vivo Y100 won't turn on do not just give up - there are plenty of tools at your disposal to recover back your files and phone.

## 6 Fixes to Unfortunately WhatsApp has stopped Error Popups On Vivo Y100
...
- Can be downloaded for free and repairs the Vivo Y100 device in few easy steps
...
Insufficient storage could be the other reason why for your WhatsApp has stopped. When your device starts running out of space, some apps may not be able to operate properly for their functions take up space in the Vivo Y100 device. And probably WhatsApp is one of them. If the space is the case with you, we suggest you the following two things to go with.
...
It is a well-known fact that Android device and Gmail account go hand in hand. To run the Vivo Y100 device smoothly, it is always asked to enter your Gmail address for further configurations. And when WhatsApp stops on your device, the reason might be your Gmail account. Most probably it is not valid now or maybe hacked. If this is the case, we suggest you to log out and log in with some another Gmail account.
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Vivo Y100 device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Vivo Y100 device is allowed to connect to the network.
...
- Supports all the new Vivo Y100 devices like Galaxy S8, S9, etc.
...
1. Connect your Vivo Y100 to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Vivo Y100 in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Vivo Y100 and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Vivo Y100 model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Vivo Y100 may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Vivo Y100 and then get into the “About Phone” option.
...
<li><a href="https://tiktok-video-files.techidaily.com/comprehensive-understanding-of-discords-functioning/"><u>Comprehensive Understanding of Discord's Functioning</u></a></li>
...
<li><a href="https://ai-editing-video.techidaily.com/3-ways-to-create-motion-text-effects-for-your-video-for-2024/"><u>3 Ways to Create Motion Text Effects for Your Video for 2024</u></a></li>
...
<li><a href="https://extra-support.techidaily.com/master-your-podcast-cookware-select-the-best-mixers-for-2024/"><u>Master Your Podcast' Cookware  Select the Best Mixers for 2024</u></a></li>

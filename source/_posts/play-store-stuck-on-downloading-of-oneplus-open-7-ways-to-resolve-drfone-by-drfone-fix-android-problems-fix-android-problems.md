...
date: 2024-06-08T06:15:57.663Z
updated: 2024-06-09T06:15:57.663Z
tags: 
  - problems
categories:
  - android
description: This article describes Play Store Stuck on Downloading Of OnePlus Open? 7 Ways to Resolve
excerpt: This article describes Play Store Stuck on Downloading Of OnePlus Open? 7 Ways to Resolve
keywords: OnePlus Open android fix,android troubleshooting,android issues,android tips,OnePlus Open android solutions,android help
...
There are two possible causes as to why your phone’s touch screen is not working. One is the touch screen may have been damaged, and the other is the OnePlus Open device may be experiencing technical difficulties.
...
- OnePlus Open P40 lite ****half touch screen not working****
- Nexus touch screen not working
- LG screen is unresponsive to touch
- OnePlus Open ****left side of the screen is not working****
...
- Remove the OnePlus Open device cover and screen protector if they are not damaged.
- If there is a sticker on the OnePlus Open device screen, you must remove it.
...
If you have already tried running the OnePlus Open device in diagnostic mode and verified that it is not physically damaged, then the problem is most likely technical. If your OnePlus Open’s screen is not responding to touches for technical reasons, follow the methods below to resolve the issue.
...
****Step 1:**** Hold the “Power” button until the OnePlus Open device turns off.
...
****Step 2:**** When the OnePlus Open device turns off, wait a few seconds.

****Step 3:**** Press and hold the “Power” button to restart the OnePlus Open device.
...
****Step 1:**** To force a restart, press and hold the OnePlus Open device’s “Power” button for an extended period.
...
****Step 2:**** Connect your OnePlus Open or tablet to the computer using the appropriate cable. Choose ****Android Repair**** from the three options shown on the left side of the screen.
...
****Step 4:**** Before repairing your OnePlus Open, you must boot it into ****Download**** ****mode****. To boot your OnePlus Open or tablet into DFU mode, follow the steps below:
...
1. Turn off the OnePlus Open device.
...
****Step 5:**** Then press the ****Next**** button. The program will then download the firmware. After downloading and verifying the firmware, the program will automatically repair your OnePlus Open. And in a while, your OnePlus Open’s system issues will be resolved.
...
That’s why Dr.Fone – System Repair might be your best solution. It has all the tools you need to keep your OnePlus Open 100%. Not only that, but with Dr.Fone, you can repair your Android system issues without dealing with any data loss.

## 7 Solutions to Fix Error Code 963 on Google Play Of OnePlus Open
...
**Note:** _Before moving to solve the error 963, we would like to inform you that the process may result in wiping away your data. And therefore, we suggest you to [make backup of your OnePlus Open](https://tools.techidaily.com/wondershare/drfone/android-backup-and-restore/) prior to fixing this Google Play error 963__._

**Phase 1: Connecting and preparing the OnePlus Open device**

Step 1 – To begin fixing error 963, run Dr.Fone after downloading and installing it on your PC. Now, pick out the ‘System Repair’ tab from the main screen. Thereupon, with the help of a USB cable, make connection between your OnePlus Open and PC
...
Step 1 – It is essential to get your OnePlus Open or tablet entered in Download mode. For this, following are the steps to be taken:

If the OnePlus Open device contains Home button:

- Turn the OnePlus Open device off and then keep holding the ‘Power’, ‘Volume Down’ and ‘Home’ buttons altogether for about 10 seconds. Next, release them all and push the ‘Volume Up’ key. This way, your device will enter the Download mode.

![fix google play error 963 on android with home key](https://images.wondershare.com/drfone/guide/android-system-repair-3.png)

If the OnePlus Open device contains no Home button:
...
This method is strictly for certain Apps which cannot be updated because they are stored on an external memory card, i.e., SD Card. Such memory enhancing chips do not support large Apps and due to a shortage of space prevents them from updating. It advisable to move such Apps from the SD Card to the OnePlus Open device’s internal memory and then try to update it.
...
<li><a href="https://animation-videos.techidaily.com/updated-how-to-make-a-video-a-live-photo-2023/"><u>Updated How to Make a Video a Live Photo 2023</u></a></li>
...
<li><a href="https://ai-editing-video.techidaily.com/do-you-want-to-know-all-about-video-frame-rates-and-speed-wondershare-filmora-will-help-you-to-get-more-information-on-this-matter/"><u>Do You Want to Know All About Video Frame Rates and Speed? Wondershare Filmora Will Help You to Get More Information on This Matter</u></a></li>
